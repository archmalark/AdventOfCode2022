...
(defn calculateOutcome [choice] 
  (* 3 (mod (- (int (.charAt  choice 0)) 1) 3) )
  )

 
(defn findWinPoint [me him outcome]
  (cond 
    (= me 0) 3    
    (= (calculateWinPoint me him) outcome) me
    :else (findWinPoint (- me 1) him outcome))
  )
 ...
 (defn calculateRoundPoint [elements]
   (+ (findWinPoint 2 (asciiMod (first elements)) (calculateOutcome (last elements))) (calculateOutcome (last elements)))
   )
